...
*Arquivo main.py -> Versão da Maquina de Estados Finita com lista ja na versao final para funcionar com o ROS2. 

*Pasta SOLE -> Dentro dela está o System Of List Elements: Uma maquina de estado finita com priorioridade e lista. Explicações melhores dentro de SOLE/anotações.txt
